...
async def first_test(dut):
    ...
    for i in range(1, 257):
        ...
        if i == 31:
            assert dut.data_block_out.value == 246047
            assert dut.valid_out.value == 1
        
        if i == 128:
            assert dut.data_block_out.value == 4_194_432
            assert dut.valid_out.value == 1
...
def test_runner():
    ...
    sources = [proj_path / "hdl" / "modulo_of_power.sv"] #grow/modify this as needed.
    ...
    runner.test(
        hdl_toplevel="modulo_of_power",
        test_module="test_modulo_of_power",
