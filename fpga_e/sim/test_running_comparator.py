...
async def first_test(dut):
    ...
    while A != 0:
        ...
        if count != 0:
            assert dut.comparison_result_out.value == 2
    ...
    while A != 0:
        ...
        if count == 0:
            assert dut.comparison_result_out.value == 2 # receiving equal from previous comparison
        if count != 0:
            assert dut.comparison_result_out.value == 2
        
        print(count, dut.block_count.value)
        if count == 0:  
            assert dut.block_count.value == 0x80
        else:
            assert dut.block_count.value == count
        count += 1
